...
@endsection
@section('content')
    @include('admin.includes.breadcrumb',['title'=>'Users','var'=>'Show All Active Users','link'=>'<a class="btn btn-outline-primary"  href="/admin"><i class="typcn typcn-chevron-left"> </i></a>'])
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Active User</h4>
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <span class="badge badge-pill badge-success">@if($user->status == 1 )Active @else Not Active @endif</span></td>
