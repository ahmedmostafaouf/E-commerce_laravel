            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Search Order</h4>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                    <div class="card">
                        <form action="{{route('search.day')}}" method="post">
                            @csrf
                            <div class="modal-body pd-20">
                                <div class="form-group">
                                    <label> Searach By Day </label>
                                    <input type="date" class="form-control" name="day">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-indigo pd-x-20"> Search</button>
                            </div>
                        </form>
                    </div>
                        </div>
