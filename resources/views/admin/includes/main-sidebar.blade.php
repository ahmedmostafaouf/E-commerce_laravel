        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='index') }}">
                    ...
                    <span class="side-menu__label">{{auth('admin')->user()->name}}</span><span
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">Main Section</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('category-create') }}">Create Section</a></li>
                    <li><a class="slide-item" href="{{ route('category-show') }}">Show Sections</a></li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">SubSections</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('all.sub.category') }}">All Sub Categories</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('all.product') }}">Show All Products </a></li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('order.index') }}"> New Orders</a></li>
                    <li><a class="slide-item" href="{{ route('order.accept') }}"> Accept Payments</a></li>
                    <li><a class="slide-item" href="{{ route('order.process') }}"> Process Delivery</a></li>
                    <li><a class="slide-item" href="{{ route('order.success') }}"> Delivery Success</a></li>
                    <li><a class="slide-item" href="{{ route('order.cancel') }}"> Cancel Order</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('order.today') }}"> Orders Today</a></li>
                    <li><a class="slide-item" href="{{ route('delivery.today') }}"> Delivery Today</a></li>
                    <li><a class="slide-item" href="{{ route('this.month') }}"> This Month</a></li>
                    <li><a class="slide-item" href="{{ route('order.search') }}"> Search</a></li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('users.active') }}">Active User</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='mail') }}">Change Password</a></li>
                    <li><a class="slide-item" href="{{ route('setting.create') }}">Setting WebSite</a></li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">Contact Us</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='table-basic') }}">Emails</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='table-data') }}">Refunded Emails</a></li>
                </ul>
            </li>
